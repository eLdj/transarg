 ...
 */
final class Version20190726014121 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE UNIQUE INDEX UNIQ_CFF6526098DE13AC ON compte (partenaire_id)');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX UNIQ_CFF6526098DE13AC ON compte');
